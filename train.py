...
from utils.generic_utils import (NoamLR, check_update, count_parameters,
                                 ...
                                 gradual_training_scheduler, KeepAverage,
                                 set_weight_decay)
        ...
        if data_loader is not None:
            ...
            if args.rank == 0:
                ...
                epoch_stats = {
                    "loss_postnet": keep_avg['avg_postnet_loss'],
                    "loss_decoder": keep_avg['avg_decoder_loss'],
                    "stop_loss": keep_avg['avg_stop_loss'], "gst_loss": keep_avg['avg_gst_loss']
                }
...
def main(args):  # pylint: disable=redefined-outer-name
    ...
    criterion_st = nn.BCEWithLogitsLoss(pos_weight=torch.tensor(10)) if c.stopnet else None

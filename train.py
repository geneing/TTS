...
def train(model, criterion, criterion_st, optimizer, optimizer_st, scheduler,
    ...
    for num_iter, data in enumerate(data_loader):
        ...
        # forward pass
        mel_output, alignments, stop_tokens = model(
    ...
    avg_total_loss = avg_mel_loss + avg_stop_loss
...
def evaluate(model, criterion, criterion_st, ap, current_step, epoch):
    ...
    test_sentences = [
        ...
        'It was neither an assault by the Picards nor the Burgundians, nor a hunt led along in procession, nor a revolt of scholars in the town of Laas.',
        ...
        if data_loader is not None:
            ...
            if args.rank == 0:
                ...
                tb_logger.tb_eval_audios(
                    current_step, {"ValAudio": ap.inv_mel_spectrogram(const_spec.T)},
                    c.audio["sample_rate"])
    ...
    if args.rank == 0 and epoch > c.test_delay_epochs:
        ...
        for idx, test_sentence in enumerate(test_sentences):
            try:
                wav, alignment, mel_spec, stop_tokens = synthesis(
